...
class AdminRatingController extends Controller
{
    ...
    public function index(Request $request): JsonResponse
    {
        ...
        return response()->json([
            'data' => $ratings->getCollection()->map(fn (SupplierRating $rating) => $this->transformRating($rating))->values(),
            'pagination' => [
    ...
    public function show(SupplierRating $rating): JsonResponse
    {
        ...
        return response()->json([
            'data' => $this->transformRating($rating),
        ]);
    }
    ...
    public function approve(Request $request, SupplierRating $rating): JsonResponse
    {
        ...
        return response()->json([
            ...
            'data' => $this->transformRating($rating->fresh()),
        ]);
    }
