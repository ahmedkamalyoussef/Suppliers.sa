...
class AdminSupplierController extends Controller
{
    ...
    private function formatSupplier(Supplier $supplier, bool $includeRelations = false): array
    {
        ...
        $base = [
            ...
            'avatar' => $this->mediaUrl($supplier->profile_image) ?? 'https://readdy.ai/api/search-image?query=Professional%20business%20avatar&width=120&height=120',
        ...
        if ($includeRelations) {
            ...
            $base['branches'] = $supplier->branches->map(fn ($branch) => $this->transformBranch($branch))->values();
        }
