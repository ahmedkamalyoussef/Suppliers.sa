...
class BranchController extends Controller
{
    ...
    {
        $branches = $request->user()->branches()->get()->map(fn (Branch $branch) => (new BranchResource($branch))->toArray($request));
    ...
    public function show(Request $request, Branch $branch)
    {
        ...
        return response()->json(['branch' => (new BranchResource($branch))->toArray($request)]);
    }
    ...
    public function updatePartial(Request $request, Branch $branch)
    {
        ...
        return response()->json([
            ...
            'branch' => (new BranchResource($branch->fresh()))->toArray($request),
        ]);
    }
