...
$profile = \App\Models\SupplierProfile::factory()->create([
...
$targetSupplier = \App\Models\Supplier::factory()->create([
    'name' => 'Target Supplier',
    'email' => 'target' . time() . '@example.com',
    'plan' => 'Premium'
]);

$targetProfile = \App\Models\SupplierProfile::factory()->create([
